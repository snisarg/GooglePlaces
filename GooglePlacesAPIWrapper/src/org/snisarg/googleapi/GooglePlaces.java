...
public class GooglePlaces {
	...
	public NearbyWrapper query(NearbyQuery nearbyQuery) throws JsonSyntaxException, IOException {
		StringBuffer query = new StringBuffer(nearbyQuery.toString());
		query.append("&key=" + apiKey);
		// System.out.println(query.toString());
		return gson.fromJson(getJSON(query.toString(), 1000000),
				NearbyWrapper.class);
	}

	public AutocompleteWrapper query(AutocompleteQuery autocompleteQuery) throws JsonSyntaxException, IOException {
	...
	public DetailsWrapper query(DetailsQuery detailsQuery) throws JsonSyntaxException, IOException {
		StringBuffer query = new StringBuffer(detailsQuery.toString());
		query.append("&key=" + apiKey);
		// System.out.println(query.toString());
		return gson.fromJson(getJSON(query.toString(), 1000000),
				DetailsWrapper.class);
	}
